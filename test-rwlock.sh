...
clang++ test-reader-pref.cpp rwlock-reader-pref.cpp -o rwlock-reader-pref -lpthread
...
clang++ test-writer-pref.cpp rwlock-writer-pref.cpp -o rwlock-writer-pref -lpthread
